...
6. report には `quest_awareness`、`control_decision`、evidence refs、残る仮定、snapshot 契約を含めます。
...
- `quest_awareness`、`control_decision`、根拠、advisor synthesis、snapshot が次の Quest へ渡せる
