...
REQUIRED_PATHS = [
    ...
    "scripts/validation/fixtures/golden_quests/metacognitive_confidence_below_50_stop.yaml",
    "scripts/validation/fixtures/golden_quests/metacognitive_confidence_below_75.yaml",
    "scripts/validation/fixtures/golden_quests/metacognitive_contradictory_evidence.yaml",
    "scripts/validation/fixtures/golden_quests/metacognitive_failed_check_first_failure.yaml",
    "scripts/validation/fixtures/golden_quests/metacognitive_memory_prevention_artifact.yaml",
    "scripts/validation/fixtures/golden_quests/metacognitive_scope_drift.yaml",
    "scripts/validation/fixtures/golden_quests/metacognitive_security_sensitive.yaml",
...
CONTROL_DECISIONS = {
    ...
    "revise_plan",
    "run_tests",
    "invoke_metacognitive_controller",
